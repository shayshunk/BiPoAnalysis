...
void AddPlotLabel(const char* label, const double x, const double y, const double size = 0.05, const int color = 1, const int align = 22, const double angle = 0);

void DecodePosition(const string& opts, double size, int &align, double &xLabel, double &yLabel);

void AddChi2Label(const TH1* dataHist, const TH1* mcHist, const string& opts, double size = 0.04, double yOffset = 0.0, bool useOnlyShapeErrors = false, bool useProb = false);
...
bool ApplyAxisStyle(TH1 *h, bool centerXTitle, bool centerYTitle, bool centerZTitle)
{
    //!Set the X axis
